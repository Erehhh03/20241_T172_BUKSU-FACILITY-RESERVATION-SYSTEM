...
import { GoogleOAuthProvider } from "@react-oauth/google"; // Make sure this import is included
...
function App() {
  return (
    <GoogleOAuthProvider clientId="797476671243-mfjgmghpn8sh29096ekjoe51vhi12jkg.apps.googleusercontent.com">
      <ThemeProvider theme={theme}>
        <Router>
          <ScrollToTop /> {/* Scroll to top when route changes */}
          <Routes>
            <Route path="/owner" element={<ProtectedRoutes source={"owner"}><SharedLayout /></ProtectedRoutes>}>
              ...
              <Route path="tenant-user/:slug" element={<TenantUserDetailPage />} />
              <Route path="contacts/all" element={<AllContacts />} />
              <Route path="contract/create" element={<CreateContractPage />} />
              <Route path="contract/:realEstateId/:slug" element={<ContractDetailPage />} />
            ...
            <Route path="/tenant" element={<ProtectedRoutes source={"tenant"}><SharedLayout /></ProtectedRoutes>}>
              ...
              <Route path="contract-agreement/:contractId" element={<ContractAgreementPage />} />
              ...
              <Route path="contract/:realEstateId/:slug" element={<ContractDetailPageTenant />} />
