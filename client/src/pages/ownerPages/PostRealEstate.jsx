          ...
          <div className="lg:w-5/12 md:w-8/12 mb-12">
            <form onSubmit={handleSubmit} id="form">
              <div className="flex flex-col justify-center items-center mt-3 mb-4">
                <h3 className="font-heading font-bold">Create Facility </h3>
                <p className="text-gray-400 text-sm">
                  Enter the details of Facility
                </p>
              </div>
              <div className="flex flex-wrap flex-col gap-2 ml-5">
                ...
                <div className="flex flex-col gap-4 my-2">
                  <h5 className="mb-1">
                    <BungalowIcon /> Facility Info
                  </h5>
                  <TextField
                    label="Price"
                    name="price"
                    type="number"
                    placeholder="Facility Rent Price "
                    required
                    value={values.price}
                    color="tertiary"
                    onChange={handleChange}
